...
struct I6_wallets: View {
    ...
    let f1 = """
        ...
        let f29 = """
          ...
          """
          let f34 = """
          These are application that run on desktop computers, mobile devices, or web browsers. They can be further categorized onto:
          """
          ...
          """
          let f36 = """
          Wallets connected to the internet, making them convenient for everyday transaction but potentially vulnerable to hacking.
          """
          ...
          """
          let f38 = """
          Wallets stored oofline, providing greater security against online threats. Cold wallets include paper wallets and hardware wallets.
          """
          ...
          """
          let f40 = """
          These are physical devices designed specifically for securely storing bitcoins. They store the user's private keys offline and require physical access to initiate
          transactions, making them highly secure against hacking attacks.
          """
          ...
          """
          let f42 = """
          A paper wallet is a physical document containing a user's public and private keys printed on paper.it's considered one of the most secure forms of storage because
          it's offline and not susceptible to hacking. However, it requires careful handling to prevent loss or damage.
          """
