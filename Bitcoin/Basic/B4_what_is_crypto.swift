            ...
            VStack(spacing: 0) {
                ScrollView {
                    VStack(alignment: .leading, spacing: 15) {
                        ...
                        Text2(title1: crypt6a, title2: crypt6)
                        Text4(title1: crypto7a, title2: crypt7, title3: crypt8, title4: crypt9)
                        
                      
                        
                        
                   Text3(title1: crypto10a, title2: crypt10, title3: crypt11)
                   Text3(title1: crypt12a, title2: crypt12, title3: crypt13)
